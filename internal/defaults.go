...
var DefaultTimezoneAbbrMap = kronos.TimezoneAbbrMap{
	...
	"ET": &kronos.AmbiguousTimezoneMap{
		...
		DstStart: func(year int) time.Time {
			...
			return kronos.GetNthWeekdayOfMonth(year, time.March, time.Sunday, 2, 2)
		},
		DstEnd: func(year int) time.Time {
			// DST ends 1st Sunday of November at 2 AM
			return kronos.GetNthWeekdayOfMonth(year, time.November, time.Sunday, 1, 2)
		},
	},
	"CST":  -360,
	"CDT":  -300,
	...
	"CET": &kronos.AmbiguousTimezoneMap{
		...
		DstStart: func(year int) time.Time {
			...
			return kronos.GetLastWeekdayOfMonth(year, time.March, time.Sunday, 2)
		},
		DstEnd: func(year int) time.Time {
			// DST ends last Sunday of October at 3 AM
			return kronos.GetLastWeekdayOfMonth(year, time.October, time.Sunday, 3)
		},
	},
	"CEST": 120,
	"EET":  120,
