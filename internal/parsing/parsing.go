// Package parsing provides shared parser utilities for kronos internal parsers.
//
// This package provides AbstractParserWithWordBoundary, a reusable base parser
// that handles word boundary checking and match adjustment for date parsing patterns.
//
// This package is internal and should not be used by external code.
package parsing
